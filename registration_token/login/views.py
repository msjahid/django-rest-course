...
class ReviewCreate(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        if teacher.number_rating == 0:
            teacher.avg_rating = serializer.validated_data['rating']

        else:
            teacher.avg_rating = (teacher.avg_rating + serializer.validated_data['rating']) / 2

        teacher.number_rating = teacher.number_rating + 1
