    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_ids', models.ManyToManyField(blank=True, related_name='subject_teacher', to='review.Subject')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('subject_ids', models.ManyToManyField(blank=True, related_name='subject_student', to='review.Subject')),
                ('teacher_ids', models.ManyToManyField(blank=True, related_name='teacher_student', to='review.Teacher')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('teacher_ids', models.ManyToManyField(blank=True, related_name='teacher_review', to='review.Teacher')),
            ],
        ),
    ]
