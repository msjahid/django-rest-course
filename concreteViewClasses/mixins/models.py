...
class Teacher(models.Model):
    ...
    type = models.CharField(max_length=10, choices=FacultyType.choices, default=FacultyType.FULL_TIME, blank=True, null=True)
...
class Student(models.Model):
    ...
    teacher_ids = models.ManyToManyField(Teacher, blank=True, related_name='teacher_student')
...
class Review(models.Model):
    ...
    teacher_ids = models.ManyToManyField(Teacher, blank=True, related_name='teacher_review')
    active = models.BooleanField(default=True, blank=True, null=True)
    ...
    def review_list(self):
        review = [i for i in self.teacher_ids.all()]
        return review