    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_ids', models.ManyToManyField(blank=True, related_name='subject_teacher', to='login.Subject')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('subject_ids', models.ManyToManyField(blank=True, related_name='subject_student', to='login.Subject')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('teacher_ids', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='teacher_review', to='login.teacher')),
            ],
        ),
    ]
