# Generated by Django 3.2.4 on 2021-06-19 06:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_ids', models.ManyToManyField(blank=True, related_name='subject_teacher', to='usermodel.Subject')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('subject_ids', models.ManyToManyField(blank=True, related_name='subject_student', to='usermodel.Subject')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('teacher_ids', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='teacher_review', to='usermodel.teacher')),
            ],
        ),
    ]
